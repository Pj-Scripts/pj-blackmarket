    ...
    <ScrollArea className="w-full h-[590px]">
      <div className="grid grid-cols-4 gap-5">
        {data.Armor.map((item, idx) => (
          <div className="w-[200px] h-[250px] bg-[#0C0C0C]  border-2 border-[#313131] rounded-xl flex items-center justify-center">
            <div className=" relative flex flex-col w-full h-full">
              ...
              <div className="bg-[#242424]/40 backdrop-blur-sm absolute inset-0 z-1 w-full h-[100px] mt-[147px] rounded-b-xl flex flex-col">
                ...
                <div className="w-full px-2">
                  <Button className="w-full bg-white text-black h-[27px] mt-2 hover:bg-white/80 hover:text-black">
                    Køb
                  </Button>
                </div>
              </div>
